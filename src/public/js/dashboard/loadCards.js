...
const url = 'https://blog-app128.herokuapp.com/'

async function loadArticlesCard(){ // Auto-run Function
    const dataFetch = await fetch('https://blog-app128.herokuapp.com/api/all')
...
async function loadMostViewedCard(){
    const dataFetch = await fetch('https://blog-app128.herokuapp.com/api/all/order')
    const data = await dataFetch.json()
...
async function loadDisplayBox(id){
    fetch(`https://blog-app128.herokuapp.com/api/${id}`)
